...
You want to contribute to pony-dotenv? Awesome.
...
First of all please [search existing issues](https://github.com/EpicEric/pony-dotenv/issues) to make sure your issue hasn't already been reported. If you cannot find a suitable issue — [create a new one](https://github.com/EpicEric/pony-dotenv/issues/new).
